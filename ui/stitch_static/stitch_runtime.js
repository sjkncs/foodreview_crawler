...
(function () {
  ...
  function orderedItemPrice(item) {
    const value = item.unit_price || item.unitPrice || item.price || item.amount || item.productPrice || item.totalPrice
